<!-- GENERATED by scripts/distribute.py — DO NOT EDIT.
     ...
     source_hash: dceafc00fe9146e94c8bf6faf27ab64b7b54ebd4eea98731ea1fac4f9771bd28 -->
...
- **etf-thesis** — Write an investment thesis for a US-listed, non-leveraged EQUITY ETF.
...
- **stock-v7-setup** — Run this first — one-time setup for the stock-v7 investment-analysis system.
- **track-record** — Capture the broker facts that expire at IBKR and the contemporaneous investment
